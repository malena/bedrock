...
;(function($) {
    ...
    function trackClick(e) {
        ...
        var $elm = $(e.target);
        var id = $elm.data('id');
        var pixel = $elm.data('pixel');
        ftGoalTag14004(id, pixel);
    }

    function ftGoalTag14004(id, pixel){
        var ftRand = Math.random() + '';
        var num = ftRand * 1000000000000000000;
        var ftGoalTagPix14004 = new Image();

        ftGoalTagPix14004.src = 'https://servedby.flashtalking.com/spot/8/6247;' + pixel + ';4669/?spotName=' + id + '&cachebuster=' + num;
